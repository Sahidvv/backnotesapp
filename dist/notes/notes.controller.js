...
let NotesController = class NotesController {
    ...
    getNotes(archived, category) {
        return this.notesService.findFiltered(archived !== undefined ? archived === 'true' : undefined, category);
    }
    async replaceNote(id, body) {
        return this.notesService.update(Number(id), body);
    }
    addCategories(id, body) {
...
__decorate([
    ...
    __metadata("design:paramtypes", [String, Object]),
    __metadata("design:returntype", Promise)
], NotesController.prototype, "replaceNote", null);
__decorate([
    (0, common_1.Patch)(':id/categories'),
    __param(0, (0, common_1.Param)('id')),
    __param(1, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, Object]),
    __metadata("design:returntype", void 0)
], NotesController.prototype, "addCategories", null);
